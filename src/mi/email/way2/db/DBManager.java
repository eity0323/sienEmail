/*
    Suneee Android Client, DBManager
    Copyright (c) 2014 Suneee Tech Company Limited
 */

package mi.email.way2.db;

import mi.email.way2.db.DaoMaster.OpenHelper;
...
public class DBManager {
	...
	private DBManager(Context context) {
		if(daoSession == null){
			if(daoMaster == null){
				OpenHelper helper = new DaoMaster.DevOpenHelper(context, context.getPackageName(), null);  
